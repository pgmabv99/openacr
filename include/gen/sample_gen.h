...
struct FDb { // sample.FDb
    ...
    sample::FRec**    ind_hashkey_buckets_elems;   // pointer to bucket array
    i32               ind_hashkey_buckets_n;       // number of elements in bucket array
    i32               ind_hashkey_n;               // number of elements in the hash table
...
// func:sample.FDb.ind_hashkey.FindX
...
// func:sample.FDb.ind_hashkey.Remove
void                 ind_hashkey_Remove(sample::FRec& row) __attribute__((nothrow));
// Reserve enough room in the hash for N more elements. Return success code.
// func:sample.FDb.ind_hashkey.Reserve
void                 ind_hashkey_Reserve(int n) __attribute__((nothrow));
